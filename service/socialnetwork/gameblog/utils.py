...
menu = [{'title': _("Моя лента"), 'url_name': 'posts:list-posts'},
...
sidebar = [
        ...
        {'url_name': 'chats:list-chats', 'icon': 'bx bx-message-square-detail', 'tooltip': _('Чат')},
        {'url_name': '#', 'icon': 'bx bx-info-circle', 'tooltip': _('Поддержка')},
        {'url_name': 'users:profile_middleware', 'icon': 'bx bx-user', 'tooltip': _('Профиль')},
]
