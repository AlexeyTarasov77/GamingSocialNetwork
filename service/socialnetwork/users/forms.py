...
class ProfileUpdateForm(forms.ModelForm):
    ...
    )  # поле для изменения username для связанного юзера
    ...
    class Meta:
        ...
        widgets = {
            ...
            "date_of_birth": forms.SelectDateWidget(
                attrs={"class": "form-control"}, years=range(1980, 2025)
            ),
        }
    ...
    def save(
        self, commit=True
    ):  # при сохранении обновить у пользователя username взятый с формы
