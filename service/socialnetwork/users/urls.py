...
urlpatterns = [
    path(f"{prefix}/<slug:username>/", views.ProfileView.as_view(), name="profile"),
    path(
    ...
    path(f"{prefix}/posts/<slug:username>/", views.my_posts_view, name="my_posts"),
    path(f"{prefix}/orders/<slug:username>/", views.my_orders_view, name="my_orders"),
