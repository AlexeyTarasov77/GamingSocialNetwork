...
from .team_handle import TeamService
...
def team_handle_view(request, slug):
    ...
    return render(request, "gameteams/teams/team_handle.html", {"team": team, "team_members": team.members.exclude(user_id=team.leader.id)})
