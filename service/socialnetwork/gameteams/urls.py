...
urlpatterns = [
    ...
    path(
        "join-requests/<slug:slug>/",
        views.TeamJoinRequestsView.as_view(),
    ...
    path(
        "make-team-leader/<int:pk>/",
        views.make_team_leader_view,
        name="make_team_leader",
    ),
    path(
        "remove-team-member/<int:pk>/",
