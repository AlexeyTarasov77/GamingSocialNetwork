...
class ChatsService:
    @staticmethod
    def get_other_user(chat: ChatRoom, curr_user_id: int):
        """
    ...
    @classmethod
    def get_chat_image(cls, chat: ChatRoom):
        """
    ...
    @staticmethod
    def is_chat_admin(user_id: int, chat: ChatRoom):
    ...
    @staticmethod
    def generate_chat_name_by_members(members: list):
